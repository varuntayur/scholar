...
public class HelloWorld {
	...
	@Path("/json")
	@Produces({ "application/json" })
	public boolean postHelloWorldJSON(String a, String b, String c, String d) {
	...
	@Path("/json")
	@Produces({ "application/json" })
	public boolean deleteHelloWorldJSON() {
		return true;// "{\"result\":\"" +
					// helloService.createHelloMessage("World") + "\"}";
	}
	...
	@Path("/json")
	@Produces({ "application/json" })
	public boolean putHelloWorldJSON() {
		return true;// "{\"result\":\"" +
					// helloService.createHelloMessage("World") + "\"}";
	}
