Ext.define('scholar.store.staff.admission.Store', {
    extend: 'Ext.data.Store',
    model: 'scholar.model.staff.admission.ScheduleSearch',
//	data : [
...
//	autoLoad: true
	...
	proxy: {
		type: 'rest',
		url: 'http://localhost:8080/scholar-rest/rest/examinationSettings',
		reader: {
			type: 'json',
			root: 'data',
			totalProperty: 'total'
