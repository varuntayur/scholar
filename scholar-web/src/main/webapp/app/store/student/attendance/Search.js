Ext.define('scholar.store.student.attendance.Search', {
    extend: 'Ext.data.Store',
    model: 'scholar.model.student.attendance.AttendanceSearch',
//	data : [
...
//	autoLoad: true
    proxy: {
		type: 'rest',
		url: 'http://localhost:8080/scholar-rest/rest/studentAttendance',
		reader: {
			type: 'json',
			root: 'data',
			totalProperty: 'total'
